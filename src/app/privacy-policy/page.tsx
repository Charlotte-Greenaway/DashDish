const PrivacyPolicy = () => {
  return (
    <div className="bg-white max-w-[1150px] mx-auto p-8">
      <p className="text-2xl text-green-700">PRIVACY POLICY</p>

      <p>Last updated February 01, 2024</p>
      <br />
      <p>
        This privacy notice for Dash Dish ('we', 'us', or 'our'), describes how
        ...
        <a
          href="http://www.dashdish.co.uk,"
          className="text-green-600 hover:text-green-800"
          target="_blank"
        >
          http://www.dashdish.co.uk,
        </a>{" "}
        ...
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
              <td className="py-4 px-6">1. WHAT INFORMATION DO WE COLLECT?</td>
            </tr>
            ...
            <tr className="bg-gray-50 border-b dark:bg-gray-800 dark:border-gray-700">
              <td className="py-4 px-6">11. WHAT ARE YOUR PRIVACY RIGHTS?</td>
            </tr>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
              <td className="py-4 px-6">
      ...
      <p>
        ...
        <br />
        recipe/ingredients data. data you input regarding ingredients or
        favourite recipes
        <br />
        <br />
        2. HOW DO WE PROCESS YOUR INFORMATION?
      ...
      <p>
        ...
        to develop and display personalised content and advertising tailored to
      ...
      <p>
        ...
        You can withdraw your consent at any time. Learn more about withdrawing
        your consent.
        <br />
        Performance of a Contract. We may process your personal information when
        we believe it is necessary to fulfil our contractual obligations to you,
      ...
      <p>
        ...
        contact us at enquiries@dashdish.co.uk.
      </p>
      <br />
      <br />
      ...
      <p>
        ...
        email us at enquiries@dashdish.co.uk.
      </p>
      <br />
      <br />
      ...
      <br />
      <br />
      <p>13. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</p>
      ...
      <p>
        ...
        on your behalf. We may deny a request from an authorised agent that does
        not submit proof that they have been validly authorised to act on your
        ...
        by email at enquiries@dashdish.co.uk, or by referring to the contact
      ...
      <p>
        ...
        email enquiries@dashdish.co.uk or visit{" "}
        <a
          href="http://www.dashdish.co.uk."
          className="text-green-600 hover:text-green-800"
          target="_blank"
      ...
      <p>
        ...
        appeal our decision, please email us at enquiries@dashdish.co.uk. Within
      ...
      <p>
        You may contact us by email at enquiries@dashdish.co.uk or visit
        <a
          href="http://www.dashdish.co.uk."
          className="text-green-600 hover:text-green-800"
          target="_blank"
      ...
      <p>
        ...
        decision, please email us at enquiries@dashdish.co.uk. Within sixty (60)
      ...
      <br />
      <br />
      <p>14. DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?</p>
      ...
      <p>
        ...
        enquiries@dashdish.co.uk or contact us by post at:
      </p>
